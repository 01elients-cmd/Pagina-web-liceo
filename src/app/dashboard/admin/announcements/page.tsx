...
export default async function AdminAnnouncementsPage() {
  ...
  // Fetch admin announcements (written by this admin user)
    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans pb-12">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 space-y-8">
        ...
        <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
          <h1 className="text-xl font-bold text-slate-900">Boletín Oficial del Plantel</h1>
          <p className="text-sm text-slate-500 mt-0.5">
            Publique anuncios informativos oficiales y comunicados dirigidos a toda la comunidad escolar.
          </p>
        </div>
